...
举个例子，如果 s1 = "abc" 且 s2 = "cde"，那么就有 offset == 'c', 'b' == 'd', 'c' == 'e'。
等价字符遵循任何等价关系的一般规则：
    自反性 ：offset == offset
    对称性 ：offset == 'b' 则必定有 'b' == offset
    传递性 ：offset == 'b' 且 'b' == 'c' 就表明 offset == 'c'
